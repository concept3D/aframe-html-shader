...
AFRAME.registerShader('html', {
  ...
  __draw (canvas) {
    ...
    const cnvW = this.__cnv.width = THREE.MathUtils.nearestPowerOfTwo(canvas.width)
    const cnvH = this.__cnv.height = THREE.MathUtils.nearestPowerOfTwo(canvas.height)
